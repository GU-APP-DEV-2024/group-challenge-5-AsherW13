...
import com.zybooks.workingwithdata.MarsPics.ImageData
import java.net.URL

class ImageCustomAdapterMars(private val dataSet: ArrayList<MarsPics.ImageData>) :
    RecyclerView.Adapter<ImageCustomAdapterMars.ViewHolder>() {
